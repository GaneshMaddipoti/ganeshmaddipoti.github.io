...
let AWSNodeDataArray = [
    ...
    {key: "AWS Users", group:"Cloud Computing", img: "assets/img/gen/gen-users.svg", category: "picTemplate",},
    {key: "Customers", group:"Cloud Computing", img: "assets/img/gen/gen-users.svg", category: "picTemplate",},
    ...
    {key: "Local Zone", color: "WhiteSmoke", category: "tree", expand: false, isGroup: true, group: "Global", img: "assets/img/aws/local-zone.svg", toolTipHTML: localZonesHTML},
    {key: "Wavelength Zone", color: "WhiteSmoke", category: "tree", expand: false, isGroup: true, group: "Global", img: "assets/img/aws/wavelength-zone.svg", toolTipHTML: waveLengthZonesHTML},
    {key: "Outposts", color: "WhiteSmoke", category: "tree", expand: false, isGroup: true, group: "Global", img: "assets/img/aws/outposts.svg", toolTipHTML: outpostsHTML},

    {key: "IAM", color: "WhiteSmoke", category: "grid", isGroup: true, group: "Global", img: "assets/img/aws/iam.svg", toolTipHTML: iamHTML, expand: false},
    {key: "User", group:"IAM", img: "assets/img/aws/user.svg", category: "picTemplate",},
    ...
    {key: "IAM Roles", group:"IAM", img: "assets/img/aws/role.svg", category: "picTemplate", toolTipHTML: iAmRolesHTML},
    {key: "Group", img: "assets/img/gen/gen-users.svg", category: "picTemplate", group: "IAM", toolTipHTML: groupsHTML,},

    {key: "Policy", group:"IAM", img: "assets/img/aws/policies.svg", category: "picTemplate", toolTipHTML: policyHTML},

    {key: "Route 53", color: "WhiteSmoke", category: "tree", expand: false, isGroup: true, group: "Global", img: "assets/img/aws/route-53.svg", toolTipHTML: route53HTML},


    {key: "Cloud Front", isGroup: true, group:"AWS", img: "assets/img/aws/edge-location.svg", category: "tree", toolTipHTML: regionalEdgeCacheHTML},
    {key: "Regional Edge Cache", group:"Cloud Front", img: "assets/img/aws/edge-location.svg", category: "picTemplate", toolTipHTML: regionalEdgeCacheHTML},
    {key: "Edge Location", group:"Cloud Front", img: "assets/img/aws/edge-location.svg", category: "picTemplate", toolTipHTML: edgeLocationsHTML},

    {key: "ELB", isGroup: true, group:"Region", img: "assets/img/aws/elb.svg", category: "tree", toolTipHTML: elbHTML},
    {key: "GwLB", group:"ELB", img: "assets/img/aws/gwlb.svg", category: "picTemplate", },
    {key: "NLB", group:"ELB", img: "assets/img/aws/nlb.svg", category: "picTemplate", },
    {key: "ALB", group:"ELB", img: "assets/img/aws/alb.svg", category: "picTemplate", },

    {key: "Auto Scaling Group", group:"Region", img: "assets/img/aws/auto-scaling-group.svg", category: "picTemplate", toolTipHTML: elbHTML},
    {key: "ECS", isGroup: true, expand: false, group:"Region", img: "assets/img/aws/ecs.svg", category: "tree", toolTipHTML: elbHTML},
    {key: "EKS", isGroup: true, expand: false, group:"Region", img: "assets/img/aws/eks.svg", category: "tree", toolTipHTML: elbHTML},

    {key: "Region", color: "WhiteSmoke", category: "tree", isGroup: true, group: "AWS", img: "assets/img/aws/region-group.svg", toolTipHTML: regionHTML},

    {key: "VPC", color: "WhiteSmoke", category: "tree", isGroup: true, group: "Region", img: "assets/img/aws/vpc-group.svg", toolTipHTML: vpcHTML},

    {key: "Internet Gateway", color: "YellowGreen", category: "picTemplate", group: "VPC", img: "assets/img/aws/internet-gateway.svg", toolTipHTML: internetGatewayHTML},
    {key: "Route Table", color: "YellowGreen", category: "picTemplate", group: "VPC", img: "assets/img/aws/route-table.svg", toolTipHTML: routeTableHTML},

    {key: "Availability Zone1", color: "WhiteSmoke", category: "tree", isGroup: true, group: "VPC",toolTipHTML: availabilityZoneHTML},
    {key: "NACL", category: "picTemplate", group: "Availability Zone1", img: "assets/img/aws/nacl.svg", toolTipHTML: naclHTML},
    {key: "Public Subnet", color: "WhiteSmoke", category: "tree", isGroup: true, group: "Availability Zone1", img: "assets/img/aws/pubsub-group.svg", toolTipHTML: subnetHTML},
    {key: "EC2 Instance", category: "grid", isGroup: true,  group: "Public Subnet", img: "assets/img/aws/ec2-instance.svg", toolTipHTML: ec2HTML},
    {key: "Elastic IP", category: "picTemplate", group: "EC2 Instance", img:"assets/img/aws/elasticIP.svg", toolTipHTML: elasticIPHTML},
    {key: "AMI", category: "picTemplate", group: "EC2 Instance", img:"assets/img/aws/ami.svg", toolTipHTML: amiHTML},
    {key: "EBS", category: "picTemplate", group: "EC2 Instance", img:"assets/img/aws/ebs.svg", toolTipHTML: ebsHTML},
    {key: "ENI", category: "picTemplate", group: "EC2 Instance", img:"assets/img/aws/eni.svg", toolTipHTML: eniHTML},
    {key: "Instance Store", category: "picTemplate", group: "EC2 Instance", img:"assets/img/aws/instanceStore.svg", toolTipHTML: ec2InstanceStoreHTML},
    {key: "Security Group", category: "picTemplate", group: "EC2 Instance", img:"assets/img/aws/rule.svg", toolTipHTML: securityGroupHTML},

    {key: "NAT Instance", category: "picTemplate", group: "Public Subnet", img: "assets/img/aws/ec2-instance.svg", toolTipHTML: natInstanceHTML},
    {key: "NAT Gateway", category: "picTemplate", group: "Public Subnet", img: "assets/img/aws/ec2-instance.svg", toolTipHTML: natGatewayHTML},

    {key: "NACL 1", category: "picTemplate", group: "Availability Zone1", img: "assets/img/aws/nacl.svg", toolTipHTML: naclHTML},
    {key: "Private Subnet1", color: "WhiteSmoke", category: "tree", isGroup: true, group: "Availability Zone1", img: "assets/img/aws/prisub-group.svg", toolTipHTML: subnetHTML},
    {key: "Server Instance", category: "picTemplate", group: "Private Subnet1", img: "assets/img/aws/ec2-instance.svg"},

    {key: "Common", color: "WhiteSmoke", category: "grid10", isGroup: true, group: "VPC",},
    {key: "CIDR", category: "picTemplate", group: "Common", img: "assets/img/aws/cidr.svg", toolTipHTML: cidrHTML},
    {key: "VPC Peering", category: "picTemplate", group: "Common", img: "assets/img/aws/vpc-peering.svg", toolTipHTML: vpcPeeringHTML},
    {key: "VPC Endpoint", category: "picTemplate", group: "Common", img: "assets/img/aws/vpc-endpoint.svg", toolTipHTML: vpcEndPointHTML},
    {key: "VPC Flow Logs", category: "picTemplate", group: "Common", img: "assets/img/aws/vpc-flowlogs.svg", toolTipHTML: vpcFlowLogsHTML},


    {key: "S3", color: "WhiteSmoke", category: "grid", isGroup: true, group: "Region", img: "assets/img/aws/s3-group.svg", toolTipHTML: s3HTML.replaceAll("\n", "<br/>")},
        {key: "Storage Classes", category: "picTemplate", group: "S3", img: "assets/img/aws/s3-glacier.svg", toolTipHTML: storageClassesHTML.replaceAll("\n", "<br/>")},
        {key: "Bucket", category: "picTemplate", group: "S3", img: "assets/img/aws/s3-bucket.svg", toolTipHTML: bucketsHTML.replaceAll("\n", "<br/>")},
        {key: "Object", category: "picTemplate", group: "S3", img: "assets/img/aws/s3-object.svg", toolTipHTML: objectsHTML.replaceAll("\n", "<br/>")},
        {key: "Replication", category: "picTemplate", group: "S3", img: "assets/img/aws/s3-replication.svg", toolTipHTML: s3replicationHTML.replaceAll("\n", "<br/>")},
        {key: "S3 Events", category: "picTemplate", group: "S3", img: "assets/img/aws/event.svg", toolTipHTML: s3EventHTML.replaceAll("\n", "<br/>")},
        {key: "S3 Encryption", category: "picTemplate", group: "S3", img: "assets/img/aws/encryption-key.svg", toolTipHTML: s3EncryptionHTML.replaceAll("\n", "<br/>")},
